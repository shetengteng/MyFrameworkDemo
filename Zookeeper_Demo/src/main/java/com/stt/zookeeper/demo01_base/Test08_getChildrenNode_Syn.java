...
public class Test08_getChildrenNode_Syn {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (isConnected) {
                ...
                String path = "/myTestRoot";
                // 获取子路径
                List<String> subPathList = zk.getChildren(path, false, null);
                for (String subPath : subPathList) {
                    subPath = path + "/" + subPath;
                    byte[] data = zk.getData(subPath, false, null);
                    String result = new String(data);
                    System.out.println("getNodeData subPath:" + subPath
                            + " result:" + result);
                }
            } else {
